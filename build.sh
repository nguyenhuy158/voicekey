...
swiftc -O main.swift Ports.swift Dictation.swift Adapters.swift Core.swift Log.swift L.swift AI.swift History.swift HUD.swift Settings.swift Stats.swift Account.swift MainWindow.swift Setup.swift SelfTest.swift -o "$APP/Contents/MacOS/VoiceKey" \
