...
swiftc -O main.swift L.swift AI.swift History.swift HUD.swift Settings.swift Stats.swift Account.swift MainWindow.swift SelfTest.swift -o "$APP/Contents/MacOS/VoiceKey" \
